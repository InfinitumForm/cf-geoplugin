...
<div class="notice notice-error"> 
	<p><?php wp_kses_post(printf(__('The database table "%s" not exists! You can try to reactivate the Geo Controller to correct this error.', 'cf-geoplugin'), "<strong>{esc_html($wpdb->cfgp_seo_redirection)}</strong>")); ?></p>
</div>
<?php endif; ?>
