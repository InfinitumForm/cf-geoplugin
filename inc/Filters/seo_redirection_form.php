...
<div class="postbox">
	...
	<div class="inside">
    	...
    	<table class="form-table cfgp-form-table" role="presentation" id="cfgp-new-seo-redirection">
        	<tbody>
                <tr>
