...
<div class="wrap wrap-cfgp" id="<?php echo sanitize_title($_GET['page']); ?>">
	<h1 class="wp-heading-inline"><i class="cfa cfa-location-arrow"></i> <?php _e('SEO redirection - Upload CSV file', CFGP_NAME);?></h1>
