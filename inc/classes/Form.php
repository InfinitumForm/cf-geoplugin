...
if (!class_exists('CFGP_Form', false)) : class CFGP_Form
{
    ...
    {
        if (!in_array($type, ['date','datetime-local','email','file','hidden','image','month','number','password','radio','range','search','tel','text','time','url','week'], true)) {
            $type = 'text';
        }
