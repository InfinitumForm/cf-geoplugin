...
if (!class_exists('CFGP_REST', false)) : class CFGP_REST extends CFGP_Global
{
    ...
    public static function rest_api_init_v1_return()
    {
        add_action('rest_api_init', function () {
            ...
            register_rest_route($namespace, '/return', [
                'methods'             => ['GET', 'POST'],
            ...
            register_rest_route($namespace, '/return/(?P<pharam>[\w\d\-_]+)', [
                'methods'             => ['GET', 'POST'],
                'permission_callback' => '__return_true',
                'callback'            => function (WP_REST_Request $data) {
            ...
            // Fix Shortcode cache
            register_rest_route($namespace, '/cache/shortcode', [
                'methods'             => ['GET', 'POST'],
                'permission_callback' => '__return_true',
                'callback'            => function (WP_REST_Request $data) {
            ...
            // Fix Banner cache
            register_rest_route($namespace, '/cache/banner', [
                'methods'             => ['GET', 'POST'],
                'permission_callback' => '__return_true',
                'callback'            => function (WP_REST_Request $data) {
