...
if (!class_exists('CFGP_OS', false)) : class CFGP_OS
{
    ...
    */
    ...
    {
        // Sandard search
        if (in_array(strtoupper(substr(PHP_OS, 0, 3)), [
            'WIN',
        ], true) !== false) {
            return true;
        }
    ...
    */
    ...
    public static function get($user_agent = null)
    {
        ...
        if (empty($user_agent)) {
            ...
            $regex_check = apply_filters('cf_geoplugin_unix_version_regex', [
                'Mac OS X 10\.1[^0-9]' => 'Mac OS X Puma',
            ]);
        } else {
            // https://stackoverflow.com/questions/18070154/get-operating-system-info-with-php
            $os_array = apply_filters('cf_geoplugin_os_version', [
                'win10'                 => 'Windows 10',
            ...
            $regex_check = apply_filters('cf_geoplugin_os_version_regex', [
                '(fedora)'                                              => 'Linux - Fedora',
                '(kubuntu)'                                             => 'Linux - Kubuntu',
                '(ubuntu)'                                              => 'Linux - Ubuntu',
                '(debian)'                                              => 'Linux - Debian',
