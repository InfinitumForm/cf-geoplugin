...
if (!class_exists('CFGP_Taxonomy', false)) : class CFGP_Taxonomy extends CFGP_Global
{
    ...
    public function add_postcode_fields($taxonomy)
    { ?>
<div class="form-field term-country-wrap">
	<label for="country"><?php esc_html_e('Country', 'cf-geoplugin'); ?></label>
	<?php CFGP_Form::select_countries(['name' => 'country', 'class' => 'cfgp_select2']); ?>
...
<tr class="form-field term-country-wrap">
	...
	<td>
		<?php CFGP_Form::select_countries(['name' => 'country', 'class' => 'cfgp_select2'], $country); ?>
...
<tr class="form-field term-city-wrap">
	...
	<td>
		<?php CFGP_Form::input('text', ['name' => 'city', 'value' => $city]); ?>
    ...
    public function place_column_postcode_fields($columns)
    {
    ...
    public function save_postcode_fields($term_id)
    {
