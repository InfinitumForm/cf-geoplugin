<h3><span class="fa fa-info-circle"></span> <?php _e('Credits',CFGP_NAME); ?></h3>
...
<h3><span class="fa fa-star-o"></span> <?php _e('PRO Package',CFGP_NAME); ?></h3>
<p><?php echo sprintf(__('%s functionality enable some additional and special options inside this plugin. This plugin is made for your needs and because of that, by purchasing a PRO package you also helping the further development and maintaince of this plugin.',CFGP_NAME),'<strong>'.__('PRO',CFGP_NAME).'</strong>'); ?></p>

<h3><span class="fa fa-code"></span> <?php _e('For Developers and Contributors',CFGP_NAME); ?></h3>
...
<h3><span class="fa fa-copyright"></span> <?php _e('Copyright',CFGP_NAME); ?></h3>
