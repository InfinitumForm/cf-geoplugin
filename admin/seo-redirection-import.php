...
<div class="container mt-5 pb-5">
    ...
    <div class="card mx-auto mt-5">
        <div class="card-header bg-transparent">
            ...
            <a href="<?php echo get_admin_url(); ?>admin.php?page=<?php echo $_GET['page']; ?>&action=export_csv" id="backup-seo" class="btn btn-outline-secondary btn-sm pull-right"><span class="fa fa-download"></span> <?php _e( 'Backup Prevous Settings', CFGP_NAME); ?></a>
        </div>
        <div class="card-footer bg-transparent">
            ...
            <p><?php _e( 'The file must be a standard comma separated CSV with a maximum of 6 columns. The order of the column is extremely important and its content is strict. If you do not follow the format and column order, CSV will be rejected.', CFGP_NAME); ?></p>
            <dl class="row mb-3">
